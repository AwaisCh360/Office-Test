  ...
  const doSend = async () => {
    ...
    if (result.ok) {
      ...
      if (result.password) {
        ...
        onExit(verifyOnly ? "history" : "overview");
      }
      return;
    }
            ...
            >
              <div className="flex items-start gap-2.5">
                ...
                <p className="text-xs leading-relaxed text-[#aaa]">
                  We generate a <span className="text-white">PDF</span>. Nothing leaves your machine.
                </p>
              </div>
            </div>
            <button
          ...
          <div className="space-y-4">
            <div className="flex items-start gap-2.5 rounded-lg border border-emerald-500/30 bg-emerald-500/5 px-3 py-2.5">
              ...
              <p className="text-xs text-emerald-200">
                Downloaded securely. Open the PDF with this password.
              </p>
            </div>
            <div>
